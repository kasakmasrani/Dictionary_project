-- Create the database
CREATE DATABASE IF NOT EXISTS dictionary_db CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci;
...
CREATE TABLE `user_auth` (
  ...
  KEY `User_ID` (`User_ID`),
  CONSTRAINT `user_auth_ibfk_1` FOREIGN KEY (`User_ID`) REFERENCES `register` (`User_ID`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
CREATE TABLE `search_history` (
  ...
  KEY `User_ID` (`User_ID`),
  CONSTRAINT `search_history_ibfk_1` FOREIGN KEY (`User_ID`) REFERENCES `register` (`User_ID`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
CREATE TABLE `synonyms` (
  ...
  KEY `Word_ID` (`Word_ID`),
  CONSTRAINT `synonyms_ibfk_1` FOREIGN KEY (`Word_ID`) REFERENCES `wordsdata` (`Word_Id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
CREATE TABLE `antonyms` (
  ...
  KEY `Word_ID` (`Word_ID`),
  CONSTRAINT `antonyms_ibfk_1` FOREIGN KEY (`Word_ID`) REFERENCES `wordsdata` (`Word_Id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;

-- Table structure for table `hypernyms`
CREATE TABLE `hypernyms` (
  `Hypernym_ID` int(11) NOT NULL AUTO_INCREMENT,
  `Word_ID` int(11) DEFAULT NULL,
  `Hypernym` varchar(100) DEFAULT NULL,
  PRIMARY KEY (`Hypernym_ID`),
  KEY `Word_ID` (`Word_ID`),
  CONSTRAINT `hypernyms_ibfk_1` FOREIGN KEY (`Word_ID`) REFERENCES `wordsdata` (`Word_Id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;

-- Table structure for table `hyponyms`
CREATE TABLE `hyponyms` (
  `Hyponym_ID` int(11) NOT NULL AUTO_INCREMENT,
  `Word_ID` int(11) DEFAULT NULL,
  `Hyponym` varchar(100) DEFAULT NULL,
  PRIMARY KEY (`Hyponym_ID`),
  KEY `Word_ID` (`Word_ID`),
  CONSTRAINT `hyponyms_ibfk_1` FOREIGN KEY (`Word_ID`) REFERENCES `wordsdata` (`Word_Id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
CREATE TABLE `sentence` (
  ...
  KEY `Word_ID` (`Word_ID`),
  CONSTRAINT `sentence_ibfk_1` FOREIGN KEY (`Word_ID`) REFERENCES `wordsdata` (`Word_Id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
CREATE PROCEDURE `Antonym` (IN `givenWord` TEXT)
BEGIN
    SELECT antonym from antonyms join wordsdata on wordsdata.word_id = antonyms.Word_ID 
    WHERE wordsdata.Word = givenWord;
END //

CREATE PROCEDURE `Hypernym` (IN `givenWord` TEXT)
BEGIN
    SELECT hypernym from hypernyms join wordsdata on wordsdata.word_id = hypernyms.Word_ID 
    WHERE wordsdata.Word = givenWord;
END //

CREATE PROCEDURE `Hyponym` (IN `givenWord` TEXT)
BEGIN
    SELECT hyponym from hyponyms join wordsdata on wordsdata.word_id = hyponyms.Word_ID 
    WHERE wordsdata.Word = givenWord;
END //

CREATE PROCEDURE `Sentence` (IN `givenWord` MEDIUMTEXT)
BEGIN
    SELECT use_in_sentence from sentence join wordsdata on wordsdata.word_id = sentence.Word_ID 
    WHERE wordsdata.Word = givenWord;
END //

CREATE PROCEDURE `Synonym` (IN `givenWord` TEXT)
BEGIN
    SELECT synonym from synonyms join wordsdata on wordsdata.word_id = synonyms.Word_ID 
    WHERE wordsdata.Word = givenWord;
END //

DELIMITER ;
-- Insert data into wordsdata
